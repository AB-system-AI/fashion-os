...
class CustomerRemoteDataSource {
  CustomerRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Customer remote push: $table ${operation.value} ${payload['id']}');
  }
