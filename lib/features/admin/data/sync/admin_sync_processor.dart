...
class AdminSyncProcessor extends EntitySyncProcessor {
  AdminSyncProcessor({
...
typedef CompanySyncProcessor = AdminSyncProcessor;
typedef BranchSyncProcessor = AdminSyncProcessor;
typedef StoreSyncProcessor = AdminSyncProcessor;
typedef WarehouseAdminSyncProcessor = AdminSyncProcessor;
typedef DepartmentSyncProcessor = AdminSyncProcessor;
typedef TeamSyncProcessor = AdminSyncProcessor;
typedef BusinessUnitSyncProcessor = AdminSyncProcessor;
typedef CostCenterAdminSyncProcessor = AdminSyncProcessor;
typedef AdminUserSyncProcessor = AdminSyncProcessor;
typedef RoleTemplateSyncProcessor = AdminSyncProcessor;
typedef UserGroupSyncProcessor = AdminSyncProcessor;
typedef PermissionAssignmentUISyncProcessor = AdminSyncProcessor;
typedef TenantSettingsSyncProcessor = AdminSyncProcessor;
typedef TenantBrandingSyncProcessor = AdminSyncProcessor;
typedef EnterpriseSettingsSyncProcessor = AdminSyncProcessor;
typedef LicenseRecordSyncProcessor = AdminSyncProcessor;
typedef SubscriptionPlanSyncProcessor = AdminSyncProcessor;
typedef UsageSnapshotSyncProcessor = AdminSyncProcessor;
typedef StorageUsageSyncProcessor = AdminSyncProcessor;
typedef ApiUsageSyncProcessor = AdminSyncProcessor;
