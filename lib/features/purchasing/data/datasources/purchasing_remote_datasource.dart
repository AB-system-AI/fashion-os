...
/// Remote purchasing API — table-per-entity push/pull.
class PurchasingRemoteDataSource {
  PurchasingRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Purchasing remote push: $table ${operation.value} ${payload['id']}');
  }
