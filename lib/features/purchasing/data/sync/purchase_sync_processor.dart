...
/// Generic purchasing entity sync processor.
class PurchaseSyncProcessor extends EntitySyncProcessor {
  PurchaseSyncProcessor({
    required PurchasingRemoteDataSource remote,
