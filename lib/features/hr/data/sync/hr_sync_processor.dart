...
class HrSyncProcessor extends EntitySyncProcessor {
  HrSyncProcessor({
...
typedef EmployeeSyncProcessor = HrSyncProcessor;
typedef AttendanceSyncProcessor = HrSyncProcessor;
typedef PayrollSyncProcessor = HrSyncProcessor;
typedef LeaveSyncProcessor = HrSyncProcessor;
