...
class AccountingSyncProcessor extends EntitySyncProcessor {
  AccountingSyncProcessor({
    required AccountingRemoteDataSource remote,
...
typedef LedgerSyncProcessor = AccountingSyncProcessor;
typedef JournalSyncProcessor = AccountingSyncProcessor;
typedef BankSyncProcessor = AccountingSyncProcessor;
typedef ExchangeRateSyncProcessor = AccountingSyncProcessor;
