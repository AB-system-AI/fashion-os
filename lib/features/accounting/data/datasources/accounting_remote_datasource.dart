...
class AccountingRemoteDataSource {
  AccountingRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Accounting remote push: $table ${operation.value} ${payload['id']}');
  }
