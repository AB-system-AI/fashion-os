...
class TreasuryRemoteDataSource {
  TreasuryRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Treasury remote push: $table ${operation.value} ${payload['id']}');
  }
