...
class TreasurySyncProcessor extends EntitySyncProcessor {
  TreasurySyncProcessor({
    required TreasuryRemoteDataSource remote,
  ...
  final TreasuryRemoteDataSource _remote;
...
typedef CashSyncProcessor = TreasurySyncProcessor;
typedef BankSyncProcessor = TreasurySyncProcessor;
typedef BankAccountSyncProcessor = TreasurySyncProcessor;
typedef PettyCashSyncProcessor = TreasurySyncProcessor;
typedef TransferSyncProcessor = TreasurySyncProcessor;
typedef ChequeSyncProcessor = TreasurySyncProcessor;
typedef ChequeBookSyncProcessor = TreasurySyncProcessor;
typedef PaymentVoucherSyncProcessor = TreasurySyncProcessor;
typedef ReceiptVoucherSyncProcessor = TreasurySyncProcessor;
typedef ExpenseRequestSyncProcessor = TreasurySyncProcessor;
typedef CashForecastSyncProcessor = TreasurySyncProcessor;
typedef BankReconciliationSyncProcessor = TreasurySyncProcessor;
typedef TreasurySettingsSyncProcessor = TreasurySyncProcessor;
