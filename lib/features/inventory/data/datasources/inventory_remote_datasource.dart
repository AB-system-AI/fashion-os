...
/// Remote inventory API — table-per-entity push/pull.
class InventoryRemoteDataSource {
  InventoryRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Inventory remote push: $table ${operation.value} ${payload['id']}');
  }
