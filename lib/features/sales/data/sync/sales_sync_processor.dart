...
class SalesSyncProcessor extends EntitySyncProcessor {
  SalesSyncProcessor({
...
typedef QuotationSyncProcessor = SalesSyncProcessor;
typedef SalesOrderSyncProcessor = SalesSyncProcessor;
typedef ShipmentSyncProcessor = SalesSyncProcessor;
typedef DeliverySyncProcessor = SalesSyncProcessor;
typedef SalesReservationSyncProcessor = SalesSyncProcessor;
typedef BackOrderSyncProcessor = SalesSyncProcessor;
typedef ReturnSyncProcessor = SalesSyncProcessor;
typedef ExchangeSyncProcessor = SalesSyncProcessor;
