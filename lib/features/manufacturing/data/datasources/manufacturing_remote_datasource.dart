...
class ManufacturingRemoteDataSource {
  ManufacturingRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Manufacturing remote push: $table ${operation.value} ${payload['id']}');
  }
