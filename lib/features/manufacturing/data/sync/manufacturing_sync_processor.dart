...
class ManufacturingSyncProcessor extends EntitySyncProcessor {
  ManufacturingSyncProcessor({
...
typedef BomSyncProcessor = ManufacturingSyncProcessor;
typedef ProductionSyncProcessor = ManufacturingSyncProcessor;
typedef WorkOrderSyncProcessor = ManufacturingSyncProcessor;
typedef MaterialIssueSyncProcessor = ManufacturingSyncProcessor;
typedef ProductionOutputSyncProcessor = ManufacturingSyncProcessor;
typedef QualityInspectionSyncProcessor = ManufacturingSyncProcessor;
typedef CapacityPlanSyncProcessor = ManufacturingSyncProcessor;
