...
class WorkflowRemoteDataSource {
  WorkflowRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Workflow remote push: $table ${operation.value} ${payload['id']}');
  }
