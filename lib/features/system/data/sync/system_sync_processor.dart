...
class SystemSyncProcessor extends EntitySyncProcessor {
  SystemSyncProcessor({
...
typedef FeatureFlagSyncProcessor = SystemSyncProcessor;
typedef SystemAuditSyncProcessor = SystemSyncProcessor;
typedef RoleDefinitionSyncProcessor = SystemSyncProcessor;
typedef PermissionAssignmentSyncProcessor = SystemSyncProcessor;
typedef SystemHealthSyncProcessor = SystemSyncProcessor;
typedef ErrorLogSyncProcessor = SystemSyncProcessor;
typedef BackgroundJobSyncProcessor = SystemSyncProcessor;
typedef SyncMonitorSyncProcessor = SystemSyncProcessor;
typedef StorageMonitorSyncProcessor = SystemSyncProcessor;
typedef LicenseRecordSyncProcessor = SystemSyncProcessor;
typedef SubscriptionRecordSyncProcessor = SystemSyncProcessor;
typedef EnvironmentSettingSyncProcessor = SystemSyncProcessor;
typedef SecuritySessionSyncProcessor = SystemSyncProcessor;
typedef DeviceRegistrationSyncProcessor = SystemSyncProcessor;
typedef LoginHistorySyncProcessor = SystemSyncProcessor;
typedef MaintenanceModeSyncProcessor = SystemSyncProcessor;
typedef SystemConfigurationSyncProcessor = SystemSyncProcessor;
typedef ReleaseNoteSyncProcessor = SystemSyncProcessor;
typedef MigrationHistorySyncProcessor = SystemSyncProcessor;
