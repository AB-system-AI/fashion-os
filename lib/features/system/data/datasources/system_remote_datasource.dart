...
class SystemRemoteDataSource {
  SystemRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('System remote push: $table ${operation.value} ${payload['id']}');
  }
