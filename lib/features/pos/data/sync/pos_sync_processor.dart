...
class PosSyncProcessor extends EntitySyncProcessor {
  PosSyncProcessor({
...
typedef SalesSyncProcessor = PosSyncProcessor;
typedef CashSessionSyncProcessor = PosSyncProcessor;
typedef ReceiptSyncProcessor = PosSyncProcessor;
typedef ReturnSyncProcessor = PosSyncProcessor;
typedef ExchangeSyncProcessor = PosSyncProcessor;
typedef LayawaySyncProcessor = PosSyncProcessor;
