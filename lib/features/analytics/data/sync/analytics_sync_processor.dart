...
class AnalyticsSyncProcessor extends EntitySyncProcessor {
...
typedef DashboardSyncProcessor = AnalyticsSyncProcessor;
typedef ReportSyncProcessor = AnalyticsSyncProcessor;
typedef KpiSnapshotSyncProcessor = AnalyticsSyncProcessor;
