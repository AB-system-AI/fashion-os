...
class AnalyticsRemoteDataSource {
  AnalyticsRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Analytics remote push: $table ${operation.value} ${payload['id']}');
  }
