...
class IntegrationsSyncProcessor extends EntitySyncProcessor {
  IntegrationsSyncProcessor({
...
typedef IntegrationConnectorSyncProcessor = IntegrationsSyncProcessor;
typedef WebhookSyncProcessor = IntegrationsSyncProcessor;
typedef ApiKeySyncProcessor = IntegrationsSyncProcessor;
typedef IntegrationLogSyncProcessor = IntegrationsSyncProcessor;
typedef ImportJobSyncProcessor = IntegrationsSyncProcessor;
typedef ExportJobSyncProcessor = IntegrationsSyncProcessor;
typedef OAuthConnectionSyncProcessor = IntegrationsSyncProcessor;
typedef PrinterProfileSyncProcessor = IntegrationsSyncProcessor;
