...
class IntegrationsRemoteDataSource {
  IntegrationsRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Integrations remote push: $table ${operation.value} ${payload['id']}');
  }
