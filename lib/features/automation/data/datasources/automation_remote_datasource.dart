...
class AutomationRemoteDataSource {
  AutomationRemoteDataSource({SupabaseClient? client}) : _client = client ?? Supabase.instance.client;
  ...
  Future<void> push({
    ...
    AppLogger.debug('Automation remote push: $table ${operation.value} ${payload['id']}');
  }
